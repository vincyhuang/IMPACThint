                ...
                wellPanel(fluidRow(
                  ...
                  column(
                    ...
                    sliderInput(
                      ...
                      "Minimum allowed years between two services",
                      1,
                      25,
                      5,
                      1,
                    ...
                    %>%
                      shinyInput_label_embed(
                        icon("info") %>%
                          bs_embed_popover(title = "Please select the minimum number of years between two concecutive services")
                      )
                  ),
                  ## col 2 ----
                  column(
...
bsCollapsePanel("Smoking Cessation Services Received (%)",
                style = "success",
                wellPanel(
                  fluidRow(
                    ## col 1 ----
                    column(
                      ...
                      sliderInput(
                        "uptake_slider_sc4",
                        "Proportion of invitees attending a service",
                        0,
                        100,
                        66,
                        0.5,
                      ...
                      %>%
                        shinyInput_label_embed(
                          icon("info") %>%
                            bs_embed_popover(title = "Please select the percentage of people who complete a service after an invitation")
                        )
                    ),
                    ## col 2 ----
                    column(
                      ...
                      numericInput("uptake_cost_sc4",
                                   "Cost per completed service", 0, 0, 500, 1)
                      %>%
                        shinyInput_label_embed(
                          icon("info") %>%
                            bs_embed_popover(title = "Please enter the cost per individual completing a service")
                        )
                    ),
                    ## col 3 ----
                    column(
